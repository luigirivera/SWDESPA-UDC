...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `udc`.`SLOT_BEFORE_INSERT` BEFORE INSERT ON `SLOT` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003TRIGGER `udc`.`SLOT_BEFORE_UPDATE` BEFORE UPDATE ON `SLOT` FOR EACH ROW
BEGIN
	IF NEW.end <= NEW.start THEN
		SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'End must be after start';
    END IF;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `udc`.`SLOT_BEFORE_DELETE` BEFORE DELETE ON `SLOT` FOR EACH ROW
BEGIN
...
-- Dump completed on 2018-04-17 22:28:34
