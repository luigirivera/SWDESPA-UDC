...
public class ClientService {
	...
	public List<Client> getAll() {
		...
		String query = "SELECT * FROM " + Client.TABLE + " INNER JOIN " + User.TABLE + " ON " + User.COL_USERID + " = "
				+ Client.COL_USERID;
	...
	public Client getGuest(int id) {
		...
		String query = "SELECT * FROM " + Client.TABLE + " INNER JOIN " + User.TABLE + " ON " + User.COL_USERID + " = "
				+ Client.COL_USERID + " WHERE " + User.COL_USERNAME + " IS NULL" + " AND " + Client.COL_USERID + " = ?";
	...
	public Client getClient(int id) { // assuming this id is userid
		...
		String query = "SELECT * FROM " + Client.TABLE + " INNER JOIN " + User.TABLE + " ON " + User.COL_USERID + " = "
				+ Client.COL_USERID + " WHERE " + User.COL_USERNAME + " IS NOT NULL" + " AND " + User.COL_USERID
				+ " = ?";
	...
	public Client getClient(String username, String password) {
		...
		String query = "SELECT * FROM " + Client.TABLE + " INNER JOIN " + User.TABLE + " ON " + User.COL_USERID + " = "
				+ Client.COL_USERID + " WHERE " + User.COL_USERNAME + " = ?" + " AND " + User.COL_PASSWORD + " = ?";
